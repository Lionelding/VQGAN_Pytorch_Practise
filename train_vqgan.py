        ...
        for epoch in range(args.epochs):
            with tqdm(range(len(train_dataset))) as pbar:
                for i, imgs in zip(pbar, train_dataset):
                    ...
                    g_loss = -torch.mean(disc_fake) # How easy the generator can fool the discriminator
...
if __name__  == "__main__":
    ...
    parser.add_argument('--batch-size', type=int, default=36, help='Input batch size for training (default: 6)')
