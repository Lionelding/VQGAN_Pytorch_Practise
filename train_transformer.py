...
class TrainTransformer:
    ...
    def train(self, args):
        ...
        for epoch in range(args.epochs):
            ...
            vutils.save_image(sampled_imgs, os.path.join("results_vqgantransformer", f"transformer_{epoch}.jpg"), nrow=4)
            plot_images(log)
            torch.save(self.model.state_dict(), os.path.join("checkpoints", f"transformer_{epoch}.pt"))

if __name__ == '__main__':
    parser = argparse.ArgumentParser(description="VQGANTransformer")
    ...
    args.dataset_path = "/home/liqiang/Data/OxfordFlowers"
    args.checkpoint_path = "/home/liqiang/Code/VQGAN_Pytorch_Practise/checkpoints/vqgan_epoch_99.pt"
